...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Bienvenido a Sistema de Tutorías</title>
              ...
              <table class="force-full-width" cellspacing="0" cellpadding="0" bgcolor="#232925">
                <tr>
                  <td style="background-color:#232925" class="logo">
                    <br>
                    <a href="#"><img src="https://dl.dropboxusercontent.com/s/x1uegbopm9z0qpb/logo_right.png?dl=0" width="150" alt="Logo"></a>
                  </td>
                  <!--<td class="icons">
                    <br>
              ...
              <table cellspacing="0" cellpadding="0" class="force-full-width" bgcolor="#232925">
                <tr>
                  ...
                  <td style="color: #ffffff;" class="header-text">
                    <br>
                    <br>
                    <span style="font-size: 24px;">Bienvenido {{$data['name']}} al Sistema de Tutorías COBACH!</span><br><br>
                    Su nueva cuenta está casi lista para usar. Sus credenciales de acceso al sistema son las siguientes.
                    <br>
                    <br>
                      <div><!--[if mso]>
                ...
                <tr>
                  <td>
                    <table cellspacing="0" cellpadding="0" class="force-full-width">
                      <tr>
                        <td>
                          <!--<span class="header">Información de su cuenta:</span><br>
                          Usuario: <a href="#">bob1031</a> <br>-->
                          Contraseña de Acceso: <a href="#">{{$data['pass']}}</a> <br><br>
                          <span class="header">Preguntas?</span><br>
                          No dude en <a href="#">contactarnos</a> en cuanquier momento para preguntas sobre su cuenta.<br><br>
                          Atentamente,<br>
                          El equipo de desarrollo del COBACH
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table class="force-full-width" cellspacing="0" cellpadding="20" bgcolor="#2b934f">
                <tr>
                  <td style="background-color:#2b934f; color:#ffffff; font-size: 14px; text-align: center;">
                    © 2017 Todos los Derechos son Reservados
                  </td>
                </tr>
              </table>
