...
<body>
	...
	<div id="second"> <!-- Datos generales -->
		...
		<p align="center"><b>INFORME INDIVIDUAL DE TUTORÍAS</b></p>
	</div> <!-- Termina Datos Generales-->
	<br>
	<div id="second"> <!-- Datos campo -->
		<p align="center"><b>Datos de Generales</b></p>
		
		<p id="analisis"><b>Plantel:</b> {{$data->campus}}&nbsp;&nbsp;&nbsp;&nbsp;<b>Alumnos Atendidos:</b> {{$data->students_attended}}&nbsp;&nbsp;&nbsp;&nbsp;<b>Turno:</b> {{$data->turn}}&nbsp;&nbsp;&nbsp;&nbsp;<b> Fecha de Elaboración:</b> {{$data->date}}&nbsp;&nbsp;&nbsp;&nbsp;</p>
		
	</div>	<!-- Termina Datos campo-->
	<div id="second">
		<p align="center"><strong>PROBLEMÁTICA ENCONTRADA: {!!$data->general_objective!!}</strong></p>
	</div>
	<br>
	<div id="second">
	...
	<table> <!-- Tabla de datos de recepción-->
		<tr>
			<th id="cd">No.</th>
			<th id="cd">OBJETIVOS</th>
			<th id="cd">ACTIVIDAD</th>
			<th id="cd">FECHAS</th>
			<th id="cd">RECURSOS MATERIALES DIDACTICOS</th>
			<th id="cd">EVIDENCIAS</th>
		</tr>
		@foreach($items as $item)
		<tr>
			<td align="center">{!!$item->id!!}</td>
			<td align="center">{!!$item->objetives!!}</td>
			<td align="center">{!!$item->activities!!}</td>
			<td align="center">{!!$item->date!!}</td>
			<td align="center">{!!$item->resources!!}</td>
			<td align="center">{!!$item->evidence!!}</td>
		</tr>
		@endforeach
